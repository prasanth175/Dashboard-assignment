...
const CustomLineChart = ({ data }) => {
  ...
  return (
    <div className='line-chart'>
      ...
      <select className='activity-dropdown' value={selectedMonth} onChange={handleMonthChange}>
        {data.map((item) => (
      ...
      <LineChart  className='activity-chart' width={800} height={250} data={selectedData.weeks} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
